...
.bank-logo-mark { position: relative; display: grid; width: 38px; height: 38px; place-items: center; overflow: hidden; border: 1px solid #e4e9f2; border-radius: 12px; background: #fff; box-shadow: 0 3px 9px rgba(15, 39, 84, .08); }
.bank-logo-mark img { position: absolute; inset: 4px; width: calc(100% - 8px); height: calc(100% - 8px); object-fit: contain; background: #fff; }
.bank-logo-fallback { display: grid; width: 100%; height: 100%; place-items: center; color: #fff; background: #263f8c; font-size: 12px; font-weight: 900; }
