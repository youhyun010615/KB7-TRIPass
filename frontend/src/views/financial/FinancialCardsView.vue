...
.filters{position:relative;z-index:20;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin-top:12px}.filter-field{position:relative;display:grid;min-width:0;gap:5px}.filter-field>span{padding-left:2px;color:#738095;font-size:10px;font-weight:700}.filter-field>button{display:flex;width:100%;min-width:0;min-height:40px;align-items:center;justify-content:space-between;gap:4px;padding:9px 9px;border:1px solid #d9e3f1;border-radius:11px;background:#fff;color:#26354b;font-size:9.5px;font-weight:700;text-align:left;white-space:nowrap}.filter-field>button[aria-expanded=true]{border-color:#4b7fd0;box-shadow:0 0 0 3px #3478e516}.filter-field>button i{flex:0 0 auto;color:#6680a7;font-size:13px;font-style:normal}.filter-menu{position:absolute;top:calc(100% + 6px);left:0;z-index:50;width:100%;min-width:118px;overflow:hidden;padding:5px;border:1px solid #d8e2f0;border-radius:12px;background:#fff;box-shadow:0 13px 30px #1737612b}.filter-menu.wide{display:grid;width:220px;max-height:244px;grid-template-columns:1fr 1fr;overflow-y:auto}.filter-menu>button{display:flex;width:100%;align-items:center;justify-content:space-between;padding:10px;border-radius:8px;background:#fff;color:#34425a;font-size:10px;text-align:left}.filter-menu>button:hover,.filter-menu>button.selected{background:#edf4ff;color:#1e5fbd;font-weight:900}.filter-menu>button small{color:#8998ad;font-size:8px}.filter-menu>button.selected small{color:#4e7fc5}
