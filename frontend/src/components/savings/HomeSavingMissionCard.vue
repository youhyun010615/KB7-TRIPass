...
<template>
  <section class="home-mission-card">
    <header>
      <div>
        <small>MONTHLY SAVING MISSION</small>
    ...
    <div class="mission-list">
      ...
      >
        <span class="mission-icon">{{ metaOf(mission.categoryCode).icon }}</span>
