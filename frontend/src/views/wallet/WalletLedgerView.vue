...
.ledger-page{padding:14px 16px 88px;background:#f2f5fa}.page-header button{width:36px;height:36px}.page-header h1{color:#29466f;font-size:20px;font-weight:700;letter-spacing:-.025em}
