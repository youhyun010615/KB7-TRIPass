...
.wallet-page{height:100vh;height:100dvh;min-height:0;overflow-x:hidden;overflow-y:auto;overscroll-behavior-y:none;scrollbar-width:none;word-break:keep-all}.wallet-page::-webkit-scrollbar{display:none}.wallet-page h1,.wallet-page h2,.wallet-page h3{text-wrap:balance}.wallet-page p{text-wrap:pretty}
...
.wallet-card-top b{color:#29466f;font-size:15px;font-weight:800}
