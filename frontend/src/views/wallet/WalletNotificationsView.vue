...
.notifications-page{padding:14px 16px 88px;background:#f2f5fa}.page-header{gap:9px}.page-header button{width:32px;height:32px}.page-header h1{color:#29466f;font-size:20px;font-weight:700;letter-spacing:-.025em}.notification-list{gap:8px;margin-top:18px}.notification-row{gap:10px;padding:12px;border-radius:15px}.notification-icon{flex-basis:32px;width:32px;height:32px;font-size:13px}.notification-body b{font-size:12.5px}.notification-body p{margin-top:4px;font-size:10.5px}.notification-body small{margin-top:5px;font-size:9.5px}
</style>
