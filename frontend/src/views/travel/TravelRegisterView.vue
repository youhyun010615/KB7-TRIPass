...
.wallet-zero-notice{display:flex;gap:11px;margin-top:14px;padding:15px;border:1px solid rgba(255,255,255,.22);border-radius:15px;color:#fff;background:#284d96}.wallet-zero-notice>i{display:grid;flex:0 0 22px;height:22px;place-items:center;border-radius:50%;background:rgba(255,255,255,.15);font-style:normal}.wallet-zero-notice>i img{width:16px;height:16px;object-fit:contain}.wallet-zero-notice b{font-size:11px}.wallet-zero-notice p{margin-top:5px;color:rgba(255,255,255,.66);font-size:9px;line-height:1.55}
