    ...
    <div ref="missionHeaderEl" class="mission-header-fixed">
      ...
      <header v-else class="page-header">
        <button type="button" class="back-button" aria-label="뒤로 가기" @click="goBack">
          ...
          <b v-if="route.query.from === 'analysis'">리포트</b>
        </button>
        <div>
          <p>AI SAVING COACH</p>
          <h1>AI 추천 미션</h1>
