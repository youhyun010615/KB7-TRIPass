...
<style scoped>
.filter-summary{margin:14px 0 12px;padding:12px 2px;border-bottom:1px solid #e5eaf1}.filter-summary-row{display:flex;align-items:center;justify-content:space-between;gap:8px}.date-summary{display:flex;min-width:0;align-items:center;gap:5px;color:#5f6f84}.date-summary strong{overflow:hidden;font-size:8.5px;font-weight:700;text-overflow:ellipsis;white-space:nowrap}.date-summary em{flex:none;color:#286ce0;font-size:8px;font-style:normal;font-weight:900}.condition-button{display:flex;flex:none;align-items:center;color:#5f6f84;font-size:8.5px;font-weight:800}.condition-button i{height:10px;margin:0 4px;border-left:1px solid #cbd3df}.condition-button span{margin-left:5px;color:#173f8d;font-size:11px}
