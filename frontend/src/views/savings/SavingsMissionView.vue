  ...
  <main class="mission-page">
    ...
    <template v-else>
      ...
      <section v-if="missionStore.options.length" class="start-summary">
        <div>
          <small>선택한 미션을 모두 달성하면 아래 금액만큼 더 모을 수 있어요.</small>
