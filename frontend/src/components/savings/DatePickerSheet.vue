...
<style scoped>
.sheet-overlay{position:fixed;z-index:100;inset:0;display:flex;align-items:flex-end;justify-content:center;background:rgba(11,42,107,.42);backdrop-filter:blur(2px)}.date-sheet{width:min(390px,100%);max-height:calc(100vh - 76px);max-height:calc(100dvh - 76px);overflow-y:auto;padding:22px 20px calc(24px + env(safe-area-inset-bottom));border-radius:24px 24px 0 0;background:#fff;box-shadow:0 -10px 30px rgba(16,25,43,.2)}header{display:flex;justify-content:space-between}h2{font-size:16.5px;font-weight:900}header p{margin-top:4px;color:#98a2b3;font-size:11px;font-weight:600}header button{border:0;background:none;color:#98a2b3;font-size:24px}.current-country{display:flex;align-items:center;gap:8px;margin-top:14px;padding:11px 13px;border:1.5px solid #1e9e6c;border-radius:13px;background:#eaf7ef}.current-country>span{font-size:15px}.current-country div{display:flex;flex:1;flex-direction:column;gap:2px}.current-country small{color:#1e9e6c;font-size:9.5px;font-weight:700}.current-country b{font-size:13.5px}.current-country em{padding:4px 9px;border-radius:99px;color:#1e9e6c;background:#fff;font-size:10.5px;font-style:normal;font-weight:800}.selection-tickets{display:grid;grid-template-columns:1fr 18px 1fr;align-items:center;gap:9px;margin-top:12px}.selection-tickets>div{padding:9px 11px;border:1.5px solid #2f6fed;border-radius:11px;background:#fff}.selection-tickets>div.active{border-color:#2f6fed;background:#fff}.selection-tickets small,.selection-tickets b{display:block}.selection-tickets small{color:#98a2b3;font-size:9.5px;font-weight:700}.selection-tickets b{margin-top:2px;color:#10192b;font-size:12.5px;font-weight:800}.selection-tickets>span{color:#98a2b3;text-align:center}.calendar-head{display:flex;align-items:center;justify-content:space-between;margin-top:14px}.calendar-head button{width:28px;height:28px;border:0;background:transparent;color:#10192b;font-size:20px}.calendar-head strong{font-size:14px;font-weight:800}.weekdays,.calendar-grid{display:grid;grid-template-columns:repeat(7,1fr)}.weekdays{margin-top:8px}.weekdays span{padding:5px 0;color:#98a2b3;text-align:center;font-size:10.5px}.weekdays span:first-child{color:#e4576c}.weekdays span:last-child{color:#98a2b3}.calendar-grid{row-gap:2px}.calendar-grid button{position:relative;height:31px;border:0;border-radius:50%;background:transparent;font-size:10.5px;font-weight:700}.calendar-grid button.past,.calendar-grid button.unavailable{color:#b4bcc9}.calendar-grid button.range{border-radius:0;background:color-mix(in srgb,var(--country-color) 12%,white);color:#173b86}.calendar-grid button.selected{z-index:1;border-radius:50%;color:#fff;background:#1e9e6c;font-weight:800}.calendar-grid button.occupied:not(.selected){border-radius:2px;color:#334155;background:color-mix(in srgb,var(--period-color) 18%,white);box-shadow:none;font-weight:800}.period-legend{margin-top:10px;padding:0;background:transparent}.period-legend>p{margin-bottom:6px;color:#98a2b3;font-size:10px;font-weight:700}.period-legend>div{display:flex;align-items:center;gap:6px;margin-top:6px;padding:10px 13px;border-radius:11px;background:#f6f8fc;box-shadow:none}.period-legend div>span{font-size:13px}.period-legend div>b{color:#10192b;font-size:12px}.period-legend div>em{margin-left:auto;color:var(--period-color);font-size:11px;font-style:normal;font-weight:700}.date-guide{display:flex;align-items:center;gap:10px;margin-top:11px;padding:12px 14px;border-radius:12px;background:#eaf1ff}.date-guide>img{width:19px;height:19px}.date-guide b{color:#0b2a6b;font-size:12px}.date-guide p{margin-top:2px;color:#4c6099;font-size:10px}.confirm{width:100%;height:50px;margin-top:12px;border:0;border-radius:14px;color:#fff;background:#0b2a6b;font-size:13.5px;font-weight:800}.confirm:disabled{background:#cbd5e1}
</style>
