...
.onboarding-register.budget-summary-step .register-content{animation:none;transform:none}
.budget-fixed-summary{position:fixed;z-index:30;left:50%;bottom:0;box-sizing:border-box;width:min(390px,100vw);padding:12px 20px calc(14px + env(safe-area-inset-bottom));transform:translateX(-50%);border-top:1px solid #e4e9f2;background:#fff;box-shadow:0 -10px 28px rgba(16,25,43,.07)}
