  ...
  <main class="page">
    ...
    <template v-else>
      <section class="ticket">
        <div class="ticket-head"><small>TRIP CHECKLIST PASS</small><b :class="{ traveling: displayStatus === '여행중' }">{{ displayStatus }}</b></div>
...
.list-heading{display:flex;align-items:center;gap:8px;margin:21px 2px 0}.list-heading h3{font-size:14px;font-weight:900}.list-heading span{color:#2662ea;font-size:10px;font-weight:850}.list-description{margin:6px 2px 13px;color:#77869d;font-size:10px;font-weight:600;line-height:1.65}
