...
<style scoped>
.filter-summary{margin:14px 0 12px;padding:12px 2px 11px;border-bottom:1px solid #e5eaf1}.filter-summary-top,.filter-summary-bottom{display:flex;align-items:center;justify-content:space-between}.search-icon{position:relative;width:18px;height:18px;border:2px solid #173f8d;border-radius:50%}.search-icon:after{position:absolute;right:-5px;bottom:-3px;width:7px;border-top:2px solid #173f8d;transform:rotate(45deg);content:''}.condition-button{display:flex;align-items:center;color:#5f6f84;font-size:9.5px;font-weight:800}.condition-button i{height:11px;margin:0 6px;border-left:1px solid #cbd3df}.condition-button span{margin-left:6px;color:#173f8d;font-size:12px}.filter-summary-bottom{margin-top:15px}.filter-summary-bottom strong{color:#5f6f84;font-size:10px;font-weight:700}.filter-summary-bottom button{color:#286ce0;font-size:8.5px;font-weight:800}
