...
<style scoped>
.mission-page{--navy:#153b86;min-height:100vh;padding:0 18px 104px;background:#eef2f8;color:#132348}.mission-header-fixed{position:fixed;top:0;left:50%;z-index:60;width:100%;max-width:390px;padding:42px 18px 14px;background:#eef2f8;transform:translateX(-50%)}
...
.report-header{flex:none;display:flex;align-items:center;justify-content:space-between;padding:18px 18px 13px;border-bottom:1px solid #e0e8f5;border-radius:24px 24px 0 0;background:#f3f6ff}
