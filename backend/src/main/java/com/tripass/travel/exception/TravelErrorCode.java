...
public enum TravelErrorCode {
    ...
    INVALID_TRIP_COUNTRY_DATES(HttpStatus.BAD_REQUEST, "INVALID_TRIP_COUNTRY_DATES", "출국일은 도착일보다 빠를 수 없습니다."),
    ...
    COUNTRY_NOT_FOUND(HttpStatus.NOT_FOUND, "COUNTRY_NOT_FOUND", "선택한 국가 정보를 찾을 수 없습니다.");
