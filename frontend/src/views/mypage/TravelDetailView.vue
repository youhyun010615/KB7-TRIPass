      ...
      <div class="bg-white rounded-2xl overflow-hidden">
        ...
        >
          <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: #EEF2FF">
            ...
            <!-- budget -->
            <svg v-if="item.icon === 'budget'" width="18" height="18" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="10" stroke="#3B5BDB" stroke-width="2"/>
              <path d="M12 6V12L16 14" stroke="#3B5BDB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <!-- schedule -->
