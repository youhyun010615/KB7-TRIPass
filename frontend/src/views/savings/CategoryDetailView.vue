...
<template>
  <main class="detail-page">
    <header><button @click="router.back()">‹</button><h1>{{ category.name }} 상세</h1><span aria-hidden="true"></span></header>
