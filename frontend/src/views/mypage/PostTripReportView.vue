    ...
    <template v-else>
      <div ref="reportContent" class="pdf-content">
        ...
        <section class="card overview">
          ...
          <div class="metric-grid"><div class="remaining"><i aria-hidden="true">▣</i><span><small>남은 예산</small><b>{{ money(r.remaining) }}</b></span></div><div class="average"><i aria-hidden="true">▥</i><span><small>일 평균</small><b>{{ money(r.dailyAverage) }}</b></span></div></div>
        </section>
        ...
        <section class="card next-trip">
          <h2>다음 여행 예산 제안</h2>
          <div class="ai-budget-guide"><i>AI</i><p>다음 여행 예산부터는 AI가 아래 내용을 반영해서 예산을 추천해줘요.</p></div>
