...
const countryData = {
  ...
  스위스: {
    ...
    day13: { total: 1_075_000, categories: [109_500, 324_200, 46_480, 283_020, 46_360, 234_640, 30_800] },
    end: { total: 1_075_000, categories: [109_500, 324_200, 46_480, 283_020, 46_360, 234_640, 30_800] },
  },
  포르투갈: {
    budget: 940_000,
    day9: { total: 0, categories: [0, 0, 0, 0, 0, 0, 0] },
    day13: { total: 710_000, categories: [200_000, 140_000, 40_000, 110_000, 20_000, 170_000, 30_000] },
    end: { total: 883_760, categories: [245_000, 180_000, 51_500, 143_800, 29_700, 198_320, 35_440] },
  },
}
...
const daily = [
  ...
  ['2027-04-13', '스위스', 231_400], ['2027-04-14', '스위스', 200_000],
  ['2027-04-14', '포르투갈', 200_000], ['2027-04-15', '포르투갈', 250_000],
  ['2027-04-16', '포르투갈', 260_000], ['2027-04-17', '포르투갈', 95_000],
  ['2027-04-18', '포르투갈', 78_760],
]
...
const walletSnapshots = {
  ...
  day13: { balance: 600_008, emergency: 600_008, eur: [267.01, 432_560], chf: [42.13, 75_000] },
  end: { balance: 600_008, emergency: 600_008, eur: [159.75, 258_800], chf: [42.13, 75_000] },
}
...
export function demoPostTripReport(tripId) {
  const categories = [509_460, 840_680, 156_300, 553_180, 110_080, 741_260, 93_240]
  ...
  return {
    ...
    targetBudget: TARGET, spent: 3_004_200, remaining: 333_800,
    dailyAverage: Math.round(3_004_200 / 15), savingsRate: 10,
