...
<template><main class="page"><div class="shell">
  <header><button @click="router.back()">‹</button><h1>고정지출 상세</h1><span aria-hidden="true"></span></header>
  <template v-if="item">
