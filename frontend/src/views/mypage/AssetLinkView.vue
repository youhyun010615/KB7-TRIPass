...
.account-identity small{margin-top:3px;color:color-mix(in srgb,var(--bank-text,#fff) 70%,transparent);font-size:7.5px;letter-spacing:.02em}
.account-slide .account-logo{flex:0 0 34px;background:color-mix(in srgb,var(--bank-text,#fff) 18%,transparent)}
.account-slide .delete-button{flex:0 0 auto;color:var(--bank-text,#fff);background:color-mix(in srgb,var(--bank-text,#fff) 12%,transparent)}
