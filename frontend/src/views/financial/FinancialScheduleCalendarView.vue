...
<template><main class="page"><div class="shell">
  <header><button @click="router.back()">‹</button><h1>금융 일정 캘린더</h1><span aria-hidden="true"></span></header>
