...
<template><main class="page"><div class="shell">
  <header><button @click="router.back()">‹</button><h1>다가오는 금융 일정</h1><span aria-hidden="true"></span></header>
