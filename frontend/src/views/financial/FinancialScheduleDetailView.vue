...
<template>
  <main class="page"><div class="shell">
    <header><button @click="router.back()">‹</button><h1>금융 일정 상세</h1></header>
    <template v-if="event">
      ...
      <button v-if="event.source === 'fixed'" class="detail-button" @click="router.push(`/asset/fixed-expenses/${event.sourceId}`)">고정지출 상세 보기</button>
    </template>
