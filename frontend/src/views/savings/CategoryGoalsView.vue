...
<template>
  <main class="form-page">
    <header><button @click="router.back()">‹</button><h1>카테고리 목표 수정</h1><span aria-hidden="true"></span></header>
...
<style scoped>
.form-page { width: min(100%,390px); min-height: 100vh; margin: 0 auto; padding: 14px 16px 24px; background:#f7f4ee; color:#151f33; }
header { display:grid; grid-template-columns:36px 1fr 36px; align-items:center; margin-bottom:18px; } header button{display:grid;width:36px;height:36px;place-items:center;border-radius:12px;background:#fff;color:#193d82;font-size:24px;font-weight:700;box-shadow:0 5px 16px rgba(36,72,117,.07)} h1{font-size:19px;font-weight:900;text-align:center}
