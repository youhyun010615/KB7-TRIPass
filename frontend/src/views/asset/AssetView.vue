...
const menus = [
  ...
  { icon: '□', title: '다가오는 금융 일정', desc: '월급과 고정지출 일정 확인', path: '/financial-schedule', wide: true },
]
...
<template>
  <main class="asset-page">
    <div class="shell">
      ...
      <section class="menus">
        <button v-for="menu in menus" :key="menu.title" :class="{ wide: menu.wide }" @click="router.push(menu.path)">
