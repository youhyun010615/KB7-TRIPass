...
.ticket{border:1px solid #bfd2f1;background:linear-gradient(135deg,#dce9fb 0%,#c8daf6 100%);color:#10234a}.ticket::before,.ticket::after{display:none}.ticket small,.ticket p{color:#6680a8}.ticket>div>b,.ticket .total em{color:#173f8d}.ticket i{border-color:#a9bfdf}.bar{background:rgba(255,255,255,.72)}.bar span{background:#2662ea}.menu-card{border:1px solid #d7e2f2;border-radius:18px;background:#fff;box-shadow:0 7px 18px rgba(23,63,141,.07)}.menu-card:first-of-type{border-color:#c9daf5;background:linear-gradient(135deg,#f1f6ff,#e8f1ff)}.menu-icon{background:#dce9fb!important;color:#173f8d!important}
</style>
