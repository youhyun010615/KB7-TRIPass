...
const templates = {
  ...
  CH: [
    ...
    ['Migros', 250_000, 8, '🛒', 1, '여행 생활용품'], ['Interlaken Souvenir', 50_000, 4, '🛍️', 2, '기념품 구매'], ['Harder Kulm', 50_000, 9, '🚞', 0, '전망대 이용'], ['Locker', 10_000, 6, '🧳', 2, '보관함 이용'],
  ],
  DE: [
    ['Zeit für Brot', 140_000, 1, '🥨', 0, '베를린 식사'], ['Markthalle Neun', 140_000, 1, '🍴', 2, '마켓 식사'], ['The Barn', 130_000, 7, '☕', 1, '커피'],
    ['dm Drogerie', 260_000, 8, '🧴', 1, '생활용품'], ['KaDeWe', 110_000, 4, '🛍️', 2, '기념품'], ['Museum Island', 100_000, 9, '🏛️', 0, '박물관 관람'], ['BVG', 70_000, 2, '🚇', 2, '교통권'],
  ],
  JP: [
    ['이치란 라멘', 120_000, 1, '🍜', 0, '도쿄 첫 식사'], ['스시다이', 110_000, 1, '🍣', 2, '스시 식사'], ['블루보틀 시부야', 100_000, 7, '☕', 1, '커피'],
    ['돈키호테', 190_000, 8, '🛒', 2, '여행 생활용품'], ['시부야 PARCO', 120_000, 4, '🛍️', 3, '쇼핑'], ['도쿄 스카이트리', 90_000, 9, '🗼', 1, '전망대'], ['Suica', 60_000, 2, '🚃', 0, '교통카드 충전'],
  ],
  HK: [
    ['Tim Ho Wan', 110_000, 1, '🥟', 0, '딤섬 식사'], ['Mak Man Kee', 100_000, 1, '🍜', 2, '완탕면 식사'], ['NOC Coffee', 90_000, 7, '☕', 1, '커피'],
    ['Market Place', 160_000, 8, '🛒', 2, '생활용품'], ['K11 MUSEA', 100_000, 4, '🛍️', 3, '쇼핑'], ['Victoria Peak', 80_000, 9, '🚠', 1, '피크 트램'], ['Octopus', 60_000, 2, '🚇', 0, '옥토퍼스 충전'],
  ],
}
