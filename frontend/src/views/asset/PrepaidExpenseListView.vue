...
<template>
  <main class="page">
    <div class="shell">
      <header><button aria-label="뒤로가기" @click="router.back()">‹</button><h1>사전 지출 금액 목록</h1></header>
