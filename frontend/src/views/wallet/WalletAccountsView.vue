...
.accounts-page{padding:42px 16px 88px;background:#f2f5fa}
.page-header{gap:9px}.page-header button{width:32px;height:32px}.page-header h1{margin-top:0;color:#29466f;font-size:20px;font-weight:700;letter-spacing:-.025em}
.summary-card{margin-top:18px;padding:18px;border-radius:20px;background:linear-gradient(135deg,#102d6d,#2874dc);box-shadow:0 12px 24px rgba(30,79,166,.16)}
.summary-card>span{font-size:11px}.summary-card strong{margin-top:6px;font-size:26px;font-weight:700}
